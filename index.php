...
<body class="text-secondary">
        ...
        <nav class="bg-primary border-bottom navbar navbar-dark navbar-expand-lg py-lg-1">
            <div class="container">
                ...
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
                    data-bs-target="#navbarNavDropdown-4" aria-controls="navbarNavDropdown-4" aria-expanded="false"
                    aria-label="Toggle navigation">
                    <span class="navbar-toggler-icon"></span>
                </button>
                <div class="collapse justify-content-end navbar-collapse" id="navbarNavDropdown-4"
                    style="color: #d5c9c9;">
                    <ul class="navbar-nav">
                        <li class="nav-item">
    ...
    <main>
            ...
            <div class="container pb-5 pt-5">
                <div class="align-content-center align-items-center d-flex float-none justify-content-center row">
                    <div class="col-lg-6 pb-3 pt-3">
                        ...
                        <a class="btn btn-light fs-5 ms-2 pe-4 ps-4 rounded-pill " id="main-btn" role="button"
                            href="#contact">Lets Talk</a>
                    </div>
                    <div
                        class="background-left-top col-lg-6 float-xl-end h-auto ms-5 ms-lg-n5 pb-5 ps-5 pt-5 text-end text-lg-center text-sm-end text-xl-center">
                        <img src="assets/images/computer-png-transparent-22.png" class="img-fluid" width="275"
                            height="0">
                    </div>
                </div>
            </div>
        ...
        <svg viewBox="0 0 1440 185" preserveAspectRatio="none" fill="currentColor" version="1.1"
            xmlns="http://www.w3.org/2000/svg" class="bg-primary img-fluid text-primary" width="100%" height="100">
                        ...
                        <div class="align-items-center row">
                            <div class="col-lg-6 ms-auto order-lg-2 py-3 text-center">
                                <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 876.272 661.473" class="img-fluid">
                                    <path
                                    ...
                                    <path
                                        ...
                                        fill="#007bff" />
                                    <path opacity=".1"
                                        d="M835.002 375.652l-1 32-18.422 32.011 15.382-35.673 4.04-28.338z" />
                                    <path
                                    ...
                                    <path
                                        d="M158.051 310.732q.343.273.664.578a10.38 10.38 0 01-.417 15.484 9.722 9.722 0 01-.814.613l1.569 52.945a8.061 8.061 0 01-5.545 7.867l-.096.02-42.989 4.579a8.899 8.899 0 11-1.722-17.713l30.644-2.7 5.3-45.85a9.876 9.876 0 01-.971-.99 10.38 10.38 0 0114.377-14.833zM139.328 649.174h11.567l5.502-44.613h-17.071l.002 44.613z"
                                        fill="#a0616a" />
                                    <path
                            ...
                            <div class="col-lg-5 order-lg-1 py-3">
                                ...
                                <h3 class="fw-bold h2 mb-1">Creating websites for small to medium businesses, clubs and
                                    personal pages</h3>
                                <p class="fs-5 fw-normal mb-lg-n1 pt-lg-4">We build simple yet professional websites.
                                </p>
                                <p class="fs-5 fw-normal mb-4 pt-lg-1">From simple one-page sites to multipal page sites
                                </p>
        ...
        <svg viewBox="0 0 1440 134" preserveAspectRatio="none" fill="currentColor" version="1.1"
            xmlns="http://www.w3.org/2000/svg" class="bg-dark d-block text-white" width="100%" height="80">
                                ...
                                <div class="border border-secondary h-100 pb-5 pe-4 ps-4 pt-5">
                                    <div class="ps-3 pe-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                            width="40" height="40" class="mb-3 text-primary">
                                            <g>
                                ...
                                <div class="border border-secondary h-100 pb-5 pe-4 ps-4 pt-5">
                                    <div class="ps-3 pe-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="40"
                                            height="40" fill="currentColor" class="mb-3 text-primary">
                                            <g>
                                                <path fill="none" d="M0 0h24v24H0z" />
                                                <path
        ...
        <svg viewBox="0 0 1440 134" preserveAspectRatio="none" fill="currentColor" version="1.1"
            xmlns="http://www.w3.org/2000/svg" class="bg-light d-block text-dark" width="100%" height="80">
            <path d="M 0 0 H 1440 V 60 C 854 276 596 -66 0 60 V 0 Z" />
        </svg>
            ...
            <div class="container pb-5 pt-5" id="work">
                ...
                <div class="row">
                    <div class=" background-center-center col-md-6 ms-lg-auto pb-3 pt-3">
                        <a href="https://soulsofthedeadmc.com"
                            class="btn btn-primary d-block pb-1 pe-0 ps-0 pt-3 px-0 text-start" target="_blank">
                            <div class="p-5">
                                <img src="assets/images/deadMC.png" width="100%"
                    ...
                    <div class="col-md-6 pb-3 pt-3">
                        <a href="https://bronxdaleautomotive.com"
                            class="btn btn-primary d-block mt-md-5 pb-1 pe-0 ps-0 pt-3 px-0 text-start" target="_blank">
                            <div class="p-5">
                    ...
                    <div class="col-md-6 pb-3 pt-3">
                        <a href="ZaidsRenovations/index.html" class="btn btn-primary d-block pb-5 pt-3 px-0 text-start"
                            target="_blank">
                            <div>
                    ...
                    <div class="col-md-6 pb-3 pt-3">
                        <a href="#" class="btn btn-primary d-block mt-md-5 pb-5 pt-3 px-0 text-start">
                            <div class="p-5">
                        ...
                        <div class="carousel-item">
                            <div class="align-items-center row text-center" style="text-align: center;">
                                <div class="col-lg-8 me-lg-auto ms-lg-auto pb-3 pt-3">
                                    ...
                                    <p class="fw-light h5 mb-4">Great commuication and feed back. Put his all into what
                                        I was looking for.</p>
        ...
        <section class="bg-primary text-center text-lg-start text-white">
            <svg viewBox="0 0 1440 185" preserveAspectRatio="none" fill="currentColor" version="1.1"
                xmlns="http://www.w3.org/2000/svg" class="bg-primary d-block text-light" width="100%" height="160">
                <path d="M 0 0 H 1440 V 60 C 1114 355 700 35 516 35 C 333 35 246 199 0 60 V 0 Z" />
            </svg>
            <div class="container pt-5">
                <div class="align-items-center row">
                    ...
                    <div class="col-lg-5 order-lg-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1120.661" height="897.38"
                            viewBox="0 0 1120.661 897.38" class="img-fluid">
                            <g data-name="Ideation and office meetings">
                                ...
                                <path data-name="Path 2429"
                                    d="M1032.663 584.38c1-21.8 11.1-39 22.5-38.5l-3.6 78.9c-11.4-.5-19.9-18.6-18.9-40.4z"
                                    opacity=".3" />
                                ...
                                <path data-name="Path 2437"
                                    ...
                                    fill="#61656d" />
                                <path data-name="Path 2438" d="M564.663 66.88h-143.3v119h143.3z"
                                    fill="var(--bs-primary)" />
                                <path data-name="Path 2439" d="M564.663 66.88h-143.3v119h143.3z" fill="#fff"
                                    opacity=".8" />
                                ...
                                <path data-name="Path 2442"
                                    d="M431.563 142.28l13.4-10.3a40.513 40.513 0 0148.1-.9l11.1-9.3a40.435 40.435 0 0150.2-1.3l.1.1v54.5h-122.9z"
                                    fill="#fff" opacity=".5" />
                                <path data-name="Path 2443" d="M488.263 112.48a9 9 0 10-9-9 9 9 0 009 9z"
                                    fill="#b2b6bb" />
                                <path data-name="Path 2444" d="M495.463 129.18l-11.1 9.1-.9-1.4 10.6-8.8z"
                                    fill="#fff" />
                                <path data-name="Path 2445" d="M421.363 66.88h-3.1v119h3.1z" fill="#b2b6bb" />
                                <path data-name="Path 2446" d="M115.263 555.08h-67.1a3.4 3.4 0 110-6.8h67.1v6.8z"
                                    fill="#b2b6bb" />
                                ...
                                <path data-name="Path 2449"
                                    d="M132.963 575.78h508v243.2h-508zm506.6 1.5h-505v240.2h505z" fill="#b2b6bb" />
                                <path data-name="Path 2450"
                                    d="M658.463 555.08h-543.3a3.4 3.4 0 110-6.8h543.2a3.4 3.4 0 01.1 6.8z"
                                    fill="#dadddf" />
                                ...
                                <path data-name="Path 2453"
                                    d="M400.263 602.28a5.2 5.2 0 10-5.2-5.2 5.2 5.2 0 005.2 5.2z" fill="#b2b6bb" />
                                ...
                                <path data-name="Path 2455"
                                    d="M400.263 681.68a5.2 5.2 0 10-5.2-5.2 5.2 5.2 0 005.2 5.2z" fill="#b2b6bb" />
                                <path data-name="Path 2456"
                                    ...
                                    opacity=".15" />
                                <path data-name="Path 2457"
                                    d="M400.263 762.08a5.2 5.2 0 10-5.2-5.2 5.2 5.2 0 005.2 5.2z" fill="#b2b6bb" />
                                ...
                                <path data-name="Path 2460"
                                    d="M70.163 834.88l-5.2 57.7a3.377 3.377 0 006.5 1.8l15.1-59.5z" fill="#dadddf" />
                                <path data-name="Path 2461"
                                    d="M72.163 868.38l6.3-1.5 8.1-32h-16.4l-5.2 57.7a3.489 3.489 0 002 3.8z"
                                    fill="#b2b6bb" />
                                <path data-name="Path 2462"
                                    d="M129.063 834.88l-5.2 57.7a3.377 3.377 0 006.5 1.8l15.1-59.5z" fill="#dadddf" />
                                <path data-name="Path 2463"
                                    d="M134.563 841.18l9.4-1.8 1.6-4.6h-16.4l-5.2 57.7a3.489 3.489 0 002 3.8z"
                                    fill="#b2b6bb" />
                                <path data-name="Path 2464"
                                    d="M580.063 834.88l5.2 57.7a3.377 3.377 0 01-6.5 1.8l-15.1-59.5z" fill="#dadddf" />
                                <path data-name="Path 2465"
                                    d="M577.163 865.58l5.6-1.4-2.7-29.3h-16.4l15.1 59.5a3.425 3.425 0 003.2 2.3h.2z"
                                    fill="#b2b6bb" />
                                <path data-name="Path 2466"
                                    d="M640.563 834.88l5.2 57.7a3.377 3.377 0 01-6.5 1.8l-15.1-59.5z" fill="#dadddf" />
                                <path data-name="Path 2467"
                                    d="M634.163 839.88l7.2-1.3-.8-3.7h-16.4l15.1 59.5a3.425 3.425 0 003.2 2.3h.2z"
                                    fill="#b2b6bb" />
                                ...
                                <path data-name="Path 2475"
                                    d="M378.363 874.88l64.9 1.6-25.9-18.5a17.259 17.259 0 01-7.2-13.3l-.9-20.3-35.3.1z"
                                    fill="#fc9d9d" />
                                ...
                                <path data-name="Path 2478"
                                    d="M268.763 865.38l.7-15.2a4.161 4.161 0 013.6-3.9l21-3.2.5-4.2-32.9.1-.1 35z"
                                    opacity=".15" />
                                ...
                                <path data-name="Path 2481"
                                    ...
                                    fill="#3f4249" />
                                <path data-name="Path 2482" d="M258.563 839.08h40.4l.8-8.3h-41.1z"
                                    fill="var(--bs-primary)" />
                                ...
                                <path data-name="Path 2493"
                                    ...
                                    opacity=".15" />
                                <path data-name="Path 2494" d="M372.863 839.08h40.3l-.6-8.3h-40.5z"
                                    fill="var(--bs-primary)" />
                                ...
                                <path data-name="Path 2499"
                                    ...
                                    fill="#fc9d9d" />
                                <path data-name="Path 2500"
                                    d="M354.363 181.48a13.8 13.8 0 10-13.8-13.8 13.8 13.8 0 0013.8 13.8z"
                                    fill="#3f4249" />
                                <path data-name="Path 2501"
                                    d="M355.363 157.48s14.5 60.8-16.7 64.9c-27 3.6-30-38.5-30-38.5l1.3-27.3z"
                                    fill="#fc9d9d" />
                                ...
                                <path data-name="Path 2504"
                                    d="M309.263 179.18s-2-5.7-8-3.1c-6.8 3-5.4 18.4 6.1 19.3 6 .5 4.8-3 3.8-7.7z"
                                    fill="#fc9d9d" />
                                ...
                                <path data-name="Path 2510"
                                    d="M332.963 188.38a2.5 2.5 0 10-2.5-2.5 2.5 2.5 0 002.5 2.5z" fill="#21252b" />
                                <path data-name="Path 2511" d="M334.063 185.58a.5.5 0 10-.5-.5.5.5 0 00.5.5z"
                                    fill="#fff" />
                                <path data-name="Path 2512"
                                    d="M352.763 188.48a2.5 2.5 0 10-2.5-2.5 2.5 2.5 0 002.5 2.5z" fill="#21252b" />
                                <path data-name="Path 2513" d="M353.863 185.68a.5.5 0 10-.5-.5.5.5 0 00.5.5z"
                                    fill="#fff" />
                                ...
                                <g data-name="Group 120">
                                    <path data-name="Path 2516"
                                        d="M387.063 445.18h-84.9a.789.789 0 01-.8-.8.86.86 0 01.8-.8h84.9a.8.8 0 010 1.6z"
                                        opacity=".15" />
                                </g>
                                <path data-name="Path 2517" d="M354.363 235.38s3.6 124.4 13.1 208.4h12.2z"
                                    opacity=".15" />
                                ...
                                <g data-name="Group 121" opacity=".15">
                                    ...
                                    <path data-name="Path 2521" d="M373.663 269.88h-90.4v4.4h90.4z"
                                        fill="var(--bs-primary)" opacity=".15" />
                                ...
                                <path data-name="Path 2536"
                                    ...
                                    opacity=".15" />
                                <path data-name="Path 2537"
                                    d="M401.463 361.58l.1-1.1h-31.7l2.7 44.5a2.187 2.187 0 002.2 2h1.5l1.1-43.8z"
                                    opacity=".15" />
                                <path data-name="Path 2538"
                                    d="M385.563 393.68a11.607 11.607 0 10-12-11.6 11.806 11.806 0 0012 11.6z"
                                    fill="var(--bs-primary)" />
                                ...
                                <path data-name="Path 2544"
                                    d="M325.463 374.88l-.1-1.7-42.2-2.7-9.9-79.4a.602.602 0 00-1.2.1l-1.7 80.3 13 .8z"
                                    opacity=".4" />
                                <path data-name="Path 2545" d="M498.763 268.08l22.3 15.6-1.6 1.6-1 1.4z"
                                    opacity=".15" />
                                ...
                                <path data-name="Path 2547"
                                    ...
                                    opacity=".4" />
                                <path data-name="Path 2548"
                                    d="M437.263 345.78l3.6-4.8-4.8-11.4-1 15.4a1.219 1.219 0 002.2.8z" opacity=".4" />
                                ...
                                <path data-name="Path 2551"
                                    d="M179.463 896.08h3.3l50.7-411a6.173 6.173 0 015.6-5.4l6.4-.6.8-5.8h-19.7z"
                                    opacity=".5" />
                                ...
                                <path data-name="Path 2555"
                                    d="M118.963 896.08h3.3l19.7-149.9 6.1-3.5 36.8-263.7.8-5.8h-19.7z" opacity=".5" />
                                <path data-name="Path 2556"
                                    d="M931.763 896.08l-19.2-148.7 6.9-4.8-30-269.5h-19.7l59.1 422.9h2.9z"
                                    opacity=".5" />
                                <path data-name="Path 2557"
                                    d="M902.863 377.88a1.7 1.7 0 10-1.7-1.7 1.7 1.7 0 001.7 1.7z" fill="#fff" />
                                ...
                                <path data-name="Path 2561"
                                    ...
                                    fill="#966363" />
                                <path data-name="Path 2562" d="M700.863 332.18l6 .2a3.333 3.333 0 003.2-2.2l9.9-36.2z"
                                    opacity=".15" />
                                ...
                                <path data-name="Path 2571" d="M784.663 382.88l-12.2-2.4-2.7 2.6 3.2 3.8z"
                                    fill="#966363" />
                                <path data-name="Path 2572" d="M784.663 382.88l-12.2-2.4-2.7 2.6 3.2 3.8z"
                                    opacity=".15" />
                                ...
                                <path data-name="Path 2576"
                                    ...
                                    fill="var(--bs-primary)" />
                                <path data-name="Path 2577" d="M747.263 431.58l1.1-11 102.1-.3 2.8 11.3z"
                                    fill="#21252b" />
                                <path data-name="Path 2578"
                                    d="M816.463 431.58a36.337 36.337 0 00-36 31.5l-35 260-27.2 7 32.3-298.5z"
                                    opacity=".2" />
                                ...
                                <path data-name="Path 2592"
                                    d="M837.963 267.68a1.7 1.7 0 10-1.7-1.7 1.7 1.7 0 001.7 1.7z" fill="#fff" />
                                <path data-name="Path 2593"
                                    d="M797.163 273.38a1.7 1.7 0 10-1.7-1.7 1.7 1.7 0 001.7 1.7z" fill="#fff" />
                                <path data-name="Path 2594"
                                    d="M854.963 386.68a1.7 1.7 0 10-1.7-1.7 1.7 1.7 0 001.7 1.7z" fill="#fff" />
                                <path data-name="Path 2595"
                                    d="M839.563 307.98a1.7 1.7 0 10-1.7-1.7 1.7 1.7 0 001.7 1.7z" fill="#fff" />
                                <path data-name="Path 2596"
                                    d="M879.163 309.08a1.7 1.7 0 10-1.7-1.7 1.7 1.7 0 001.7 1.7z" fill="#fff" />
                                <path data-name="Path 2597"
                                    d="M776.263 299.78a1.7 1.7 0 10-1.7-1.7 1.7 1.7 0 001.7 1.7z" fill="#fff" />
                                <path data-name="Path 2598"
                                    d="M741.663 311.28a1.7 1.7 0 10-1.7-1.7 1.7 1.7 0 001.7 1.7z" fill="#fff" />
                                <path data-name="Path 2599"
                                    d="M726.863 291.98a1.7 1.7 0 10-1.7-1.7 1.7 1.7 0 001.7 1.7z" fill="#fff" />
                                <path data-name="Path 2600"
                                    d="M721.763 342.78a1.7 1.7 0 10-1.7-1.7 1.7 1.7 0 001.7 1.7z" fill="#fff" />
                                <path data-name="Path 2601"
                                    d="M691.663 355.68a1.7 1.7 0 10-1.7-1.7 1.7 1.7 0 001.7 1.7z" fill="#fff" />
                                <path data-name="Path 2602"
                                    d="M670.963 337.28a1.7 1.7 0 10-1.7-1.7 1.7 1.7 0 001.7 1.7z" fill="#fff" />
                                <path data-name="Path 2603"
                                    d="M760.563 261.48a1.7 1.7 0 10-1.7-1.7 1.7 1.7 0 001.7 1.7z" fill="#fff" />
                                <path data-name="Path 2604"
                                    d="M802.963 321.28a1.7 1.7 0 10-1.7-1.7 1.7 1.7 0 001.7 1.7z" fill="#fff" />
                                <path data-name="Path 2605"
                                    d="M790.063 371.48a1.7 1.7 0 10-1.7-1.7 1.7 1.7 0 001.7 1.7z" fill="#fff" />
                                <path data-name="Path 2606"
                                    d="M816.863 407.28a1.7 1.7 0 10-1.7-1.7 1.7 1.7 0 001.7 1.7z" fill="#fff" />
                                <path data-name="Path 2607"
                                    d="M769.763 344.08a1.7 1.7 0 10-1.7-1.7 1.7 1.7 0 001.7 1.7z" fill="#fff" />
                                <path data-name="Path 2608"
                                    d="M758.863 383.88a1.7 1.7 0 10-1.7-1.7 1.7 1.7 0 001.7 1.7z" fill="#fff" />
                                <path data-name="Path 2609"
                                    d="M870.163 347.38a1.7 1.7 0 10-1.7-1.7 1.7 1.7 0 001.7 1.7z" fill="#fff" />
                                <path data-name="Path 2610"
                                    d="M827.363 354.78a1.7 1.7 0 10-1.7-1.7 1.7 1.7 0 001.7 1.7z" fill="#fff" />
                                <path data-name="Path 2611"
                                    d="M817.363 255.98l13-7.9-7.6-1.6-53.6.6-5.2 1.4 12.8 7.6a39.443 39.443 0 0040.6-.1z"
                                    opacity=".6" />
                                <path data-name="Path 2612"
                                    d="M822.563 163.68a16.5 16.5 0 10-16.5-16.5 16.5 16.5 0 0016.5 16.5z"
                                    fill="#21252b" />
                                ...
                                <path data-name="Path 2617"
                                    ...
                                    fill="#966363" />
                                <path data-name="Path 2618"
                                    d="M792.463 198.68a2.4 2.4 0 10-2.4-2.4 2.4 2.4 0 002.4 2.4z" fill="#21252b" />
                                <path data-name="Path 2619" d="M791.463 196.28a.5.5 0 10-.5-.5.5.5 0 00.5.5z"
                                    fill="#fff" />
                                <path data-name="Path 2620"
                                    d="M773.763 198.68a2.4 2.4 0 10-2.4-2.4 2.4 2.4 0 002.4 2.4z" fill="#21252b" />
                                <path data-name="Path 2621" d="M772.763 196.18a.5.5 0 10-.5-.5.5.5 0 00.5.5z"
                                    fill="#fff" />
                                ...
                                <path data-name="Path 2623"
                                    ...
                                    fill="#21252b" />
                                <path data-name="Path 2624"
                                    d="M813.263 210.38s10.5 1.7 13.6-8.5c3.1-10.3-9.7-13.3-12.4-2.9l-2.4 11.4z"
                                    fill="#966363" />
                                ...
                                <path data-name="Path 2626"
                                    ...
                                    fill="#fff" />
                                <path data-name="Path 2627"
                                    d="M816.463 208.98a2.1 2.1 0 10-2.1-2.1 2.1 2.1 0 002.1 2.1z"
                                    fill="var(--bs-primary)" />
                                ...
                                <path data-name="Path 2632"
                                    d="M780.663 214.08a.441.441 0 00-.4.6 6.878 6.878 0 0012.4 0c.1-.3 0-.6-.4-.6z"
                                    fill="#fff" />
                                ...
                                <path data-name="Path 2642"
                                    d="M680.263 189.78a14.3 14.3 0 10-14.3-14.3 14.3 14.3 0 0014.3 14.3z"
                                    fill="var(--bs-primary)" />
                                ...
                                <path data-name="Path 2648"
                                    ...
                                    opacity=".15" />
                                <path data-name="Path 2649"
                                    d="M723.863 412.78l.1-1.1h-31.7l2.7 44.5a2.187 2.187 0 002.2 2h1.5l1.1-43.8z"
                                    opacity=".15" />
                                <path data-name="Path 2650" d="M698.563 432.48a9.005 9.005 0 0118 0"
                                    fill="var(--bs-primary)" />
                                <path data-name="Path 2651" d="M722.063 434.98h-28.4l.5 8.7h27.2z"
                                    fill="var(--bs-primary)" />
                        ...
                        <div class="container pb-4 pt-4">
                            <div class="row">
                                ...
                                <div class="col col-lg-6 col-xl-5 py-3">
                                    ...
                                    <form action="index.php"name="contactForm" method="POST" enctype="multipart/form-data" id="myForm">
                                ...
                                <div class="col-lg-6 ms-auto py-3" style="text-align: center;">
                                    <ul style="list-style-type: none; text-transform: uppercase;"
                                        class="lh-lg list-unstyled">
                                        <li class="fs-5 fst-italic fw-bolder text-black-50 text-center">Web Development
                                        </li>
                                        ...
                                        <li class="fs-5 fst-italic fw-bolder text-black-50 text-center">Digital
                                            Marketing</li>
                                        <li class="fs-5 fst-italic fw-bolder text-black-50 text-center">Content Writing
                                        </li>
                                    </ul>
                                    <div class="d-inline-flex flex-wrap" style="margin-top: 4px;">
                                        <a href="#" class="btn btn-secondary me-1 p-2 rounded-circle"
                                            aria-label="facebook"> <svg viewBox="0 0 24 24" fill="currentColor"
                                                width="1rem" height="1rem" class="d-block">
                                                <path
                                                    d="M14 13.5h2.5l1-4H14v-2c0-1.03 0-2 2-2h1.5V2.14c-.326-.043-1.557-.14-2.857-.14C11.928 2 10 3.657 10 6.7v2.8H7v4h3V22h4v-8.5z" />
                                            </svg> </a>
                                        <a href="#" class="btn btn-secondary me-1 p-2 rounded-circle"
                                            aria-label="twitter"> <svg viewBox="0 0 24 24" fill="currentColor"
                                                width="1rem" height="1rem" class="d-block">
                                                <path
                                    ...
                                    <div>
                                        <a href="projects.html" class="h1" style="font-size: 39px; color: #151414;"><svg
